...
for required in README.md CHANGELOG.md docs/README.md docs/GETTING_STARTED.md docs/CONFIGURATION.md docs/TESTING.md docs/DEVELOPMENT.md docs/COMPATIBILITY.md; do
