...
void test_eeprom_storage_methods() {
    ...
    TEST_ASSERT_EQUAL_UINT16_MESSAGE(1024, getConfigEEPROMSize(), "V2 uses two transactional slots");
    ...
    TEST_ASSERT_EQUAL_UINT16_MESSAGE(2, DeviceFrameworkStorage::STORAGE_FORMAT_VERSION,
                                   "Storage format must be V2");
}
